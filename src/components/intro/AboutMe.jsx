    ...
    <div>
      <section className="py-10">
        <h3
          ...
          className="text-5xl py-2 text-black font-medium dark:text-clotted-cream md:text-6xl max-w-md">About Me</h3>
        ...
        <div className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-2xl md:text-md">
          <div className="typewriter">
            <h1 className="text-sm py-5 leading-8 text-gray-800 dark:text-gray-800 max-w-1xl md:text-sm">A little back story...</h1>
          </div>
